                     ...
                     <?php $__env->slot('trigger', null, []); ?> 
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150">
                            ...
                            <?php if(auth()->guard()->guest()): ?>
                                <div>
                                    <a href="<?php echo e(route('login')); ?>" class="bg-white text-indigo-600 font-semibold rounded-lg shadow-md hover:bg-gray-100 transition"> 
                                     Login
                                    </a>
                                     / 
                                    <a href="<?php echo e(route('register')); ?>" class="bg-white text-indigo-600 font-semibold rounded-lg shadow-md hover:bg-gray-100 transition"> 
                                     Register
                                    </a>
                                    </div>
                            <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\laravel\devHub\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>